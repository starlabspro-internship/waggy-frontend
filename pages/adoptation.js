          ...
          <div class="flex">
              ...
              <div class="flex flex-col md:flex-row gap-3 w-full px-4">
                  ...
                  <div class="flex justify-between  gap-3 md:gap-6">
                      <div class="bg-sky-200 cursor-pointer text-sky-600 rounded-[15.66px] h-[60px] md:h-[65px] hover:text-white hover:bg-blue w-full md:w-[65px] md:text-[15px] flex justify-center items-center" onclick="filterSpecies('Cat')">Cat</div>
                      <div class="bg-sky-200 cursor-pointer text-sky-600 rounded-[15.66px] h-[60px] md:h-[65px] hover:text-white hover:bg-blue  w-full md:w-[65px] md:text-[15px] flex justify-center items-center" onclick="filterSpecies('Dog')">Dog</div>
                  </div>
